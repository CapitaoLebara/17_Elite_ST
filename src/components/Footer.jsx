...
export const Footer = () => {
  return (
    <footer id='contact' className='mt-4 w-full h-auto  sm:grid flex flex-col items-center  bg-zinc-600 px-[30px] py-[20px]'>
        ...
        <Form/>
            ...
            <div className=' mt-4  text-white'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <p>(75)9 8101-5835 <br/> (75) 3482-3241</p>
                    </div>
            ...
            <div className=' mt-4 text-white '>
                ...
                <div className='flex items-center mb-4 '>
                    <BsTwitter   className='text-[#f0c70a] text-[1.7rem]  mr-[0.7rem]'/>
                    <p className='text-[1.3rem]'>Twitter</p>
                </div>
        ...
        <p className='mt-4 text-center text-[13px] text-white'>COPYRIGHT © 2022 <span className='text-[#f0c70a]'>HAWK_WEB</span> | ALL RIGHTS RESERVED!</p>
